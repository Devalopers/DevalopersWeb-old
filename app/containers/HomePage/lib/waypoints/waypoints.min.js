...
(function() {
  ...
  (e.prototype.checkEmpty = function() {
    ...
    let i = this.element == this.element.window;
    ...
    for (const r in t) {
      ...
      for (const a in this.waypoints[r]) {
        ...
        const d = this.waypoints[r][a];
            var f = d.options.offset;
        let w = d.triggerPoint;
            let y = 0;
        let g = w == null;
...
(function() {
  ...
  (i.prototype.next = function(e) {
    ...
    let o = i === this.waypoints.length - 1;
