...
(function(a, b, c, d) {
  var e = function(c) {
    ...
    a(b).resize(function() {
      d._core.settings.autoHeight &&
            (d._intervalId != null && clearTimeout(d._intervalId),
  ...
  (e.prototype.update = function() {
    const b = this._core._current;
        ...
        let d = this._core.settings.lazyLoad;
        var e = this._core.$stage
          .children()
      .toArray()
          .slice(b, c);
        const f = [];
...
(function(a, b, c, d) {
  ...
  (e.prototype.thumbnail = function(b, c) {
    ...
    let e;
        let f;
    const g =
          c.width && c.height ? `width:${c.width}px;height:${c.height}px;` : '';
        let h = b.find('img');
        var i = 'src';
        let j = '';
  ...
  (e.prototype.swap = function() {
    if (
      ...
      const d = this.core.$stage.children().eq(this.previous);
          let e = this.core.$stage.children().eq(this.next);
...
(function(a, b, c, d) {
  ...
  (e.prototype.draw = function() {
    ...
    let e = this._core.relative(this._core.current());
...
(function(a, b, c, d) {
    ...
    a(b).on(
      ...
      a.proxy(function(a) {
        ...
        let f = this._hashes[c] && e.index(this._hashes[c]);
        f !== d &&
