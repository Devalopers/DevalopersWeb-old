...
!(function(e, t) {
  ...
  let v = { type: !0, src: !0, noModule: !0 };
  function m(e, t, n) {
    let i;
    let o = (t = t || r).createElement('script');
  ...
  const E = (function(e) {
    ...
    let F = new RegExp(`^${  M  }*,${  M  }*`);
    var _ = new RegExp(`^${  M  }*([>+~]|${  M  })${  M  }*`);
    var z = new RegExp(`=${  M  }*([^\\]'"]*?)${  M  }*\\]`, 'g');
    var X = new RegExp(W);
    let U = new RegExp(`^${  R  }$`);
    var V = {
      ID: new RegExp(`^#(${  R  })`),
    ...
    let G = /^(?:input|select|textarea|button)$/i;
    var Y = /^h\d$/i;
    let Q = /^[^{]+\{\s*\[native \w/;
    let J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
    var K = /[+~]/;
    let Z = new RegExp(`\\\\([\\da-f]{1,6}${  M  }?|(${  M  })|.)`, 'ig');
    ...
    var te = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g;
    var ne = function(e, t) {
      return t
        ? e === '\0'
          ? '\ufffd'
    ...
    (n = oe.support = {}),
      ...
      var o = i && N.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !g) : void 0;
        return void 0 !== o
          ? o
          : n.attributes || !g
          ? e.getAttribute(t)
    ...
    function Te(e, t, n, r, i, o) {
      return (
        ...
        se(function(o, a, s, u) {
          ...
          let d = [];
          var h = a.length;
          let g = o || be(t || '*', s.nodeType ? [s] : s, []);
          var y = !e || (!o && t) ? g : we(g, p, e, s, u);
    ...
    function Ee(e, t) {
      ...
      let o = function(o, a, s, u, c) {
        ...
        var b = [];
        var w = l;
        var C = o || (i && r.find.TAG('*', c));
        let E = (T += w == null ? 1 : Math.random() || 0.1);
        var k = C.length;
        for (
          c && (l = a === d || a || c);
          m !== k && (f = C[m]) != null;
  ...
  let D = w.expr.match.needsContext;
  function N(e, t) {
  ...
  (w.filter = function(e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function(e) {
        return !!j(this, typeof e === 'string' && D.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  let q;
  ...
  let O = { children: !0, contents: !0, next: !0, prev: !0 };
  w.fn.extend({
    has(e) {
      let t = w(e, this);
        var n = t.length;
        ...
        arguments.length < n
          ...
          : void 0 === t
            ...
            : this.each(function() {
              ...
              'fx' === e && n[0] !== 'inprogress' && w.dequeue(this, e);
            })
      );
    },
      dequeue(e) {
  ...
  var we = /^key/;
  let Te = /^(?:mouse|pointer|contextmenu|drag|drop)|click/;
  let Ce = /^([^.]*)(?:\.(.+)|)/;
  function Ee() {
    return !0;
  }
  ...
  (w.event = {
    ...
    dispatch(e) {
      let t = w.event.fix(e);
        ...
        var l = (J.get(this, 'events') || {})[t.type] || [];
        var c = w.event.special[t.type] || {};
  ...
  w.extend({
    ...
    clone(e, t, n) {
      let r;
        ...
        var a;
        var s = e.cloneNode(!0);
        var u = w.contains(e.ownerDocument, e);
      if (
        !(
          h.noCloneChecked ||
  ...
  var Xe = /^--/;
  let Ue = { position: 'absolute', visibility: 'hidden', display: 'block' };
  var Ve = { letterSpacing: '0', fontWeight: '400' };
  var Ge = ['Webkit', 'Moz', 'ms'];
  let Ye = r.createElement('div').style;
  function Qe(e) {
    if (e in Ye) return e;
  ...
  function et(e, t, n) {
    const r = $e(e);
    var i = Fe(e, t, r);
    let o = w.css(e, 'boxSizing', !1, r) === 'border-box';
    let a = o;
    if (We.test(i)) {
      if (!n) return i;
      i = 'auto';
    ...
    w.each(['height', 'width'], function(e, t) {
      w.cssHooks[t] = {
        ...
        set: function(e, n, r) {
          let i;
        var o = $e(e);
          let a = w.css(e, 'boxSizing', !1, o) === 'border-box';
        var s = r && Ze(e, t, r, a, o);
          return (
            a &&
  ...
  function pt(e, t, n) {
    ...
    var i;
    let o = 0;
    let a = pt.prefilters.length;
    var s = w.Deferred().always(function() {
      delete u.elem;
    });
    var u = function() {
      if (i) return !1;
  ...
  (w.Animation = w.extend(pt, {
    ...
    (function() {
      ...
      let t = r.createElement('select').appendChild(r.createElement('option'));
      (e.type = 'checkbox'),
        (h.checkOn = e.value !== ''),
      ...
      valHooks: {
        ...
        select: {
          ...
          var o = e.selectedIndex;
            let a = e.type === 'select-one';
          var s = a ? null : [];
            let u = a ? o + 1 : i.length;
  ...
  w.extend(w.event, {
    trigger(t, n, i, o) {
      let a;
        ...
        var x = f.call(t, 'namespace') ? t.namespace.split('.') : [];
      if (
        ((s = h = u = i = i || r),
        i.nodeType !== 3 &&
          i.nodeType !== 8 &&
  ...
  const St = /\[\]$/;
  let Dt = /\r?\n/g;
  var Nt = /^(?:submit|button|image|reset|file)$/i;
  let At = /^(?:input|select|textarea|keygen)/i;
  function jt(e, t, n, r) {
    let i;
    if (Array.isArray(t))
  ...
  var Ht = /([?&])_=[^&]*/;
  let Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm;
  var Pt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
  var Mt = /^(?:GET|HEAD)$/;
  var Rt = /^\/\//;
  var It = {};
  let Wt = {};
  var $t = '*/'.concat('*');
  var Bt = r.createElement('a');
  Bt.href = Ct.href;
  function Ft(e) {
    return function(t, n) {
  ...
  function zt(e, t) {
    let n;
    var r;
    let i = w.ajaxSettings.flatOptions || {};
  ...
  w.extend({
    ...
    ajax(t, n) {
      ...
      var i;
        ...
        var h = w.ajaxSetup({}, n);
        var g = h.context || h;
        var y = h.context && (g.nodeType || g.jquery) ? w(g) : w.event;
        var v = w.Deferred();
        var m = w.Callbacks('once memory');
        var x = h.statusCode || {};
        var b = {};
        var T = {};
        var C = 'canceled';
