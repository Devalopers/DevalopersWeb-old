...
!(function(a, b) {
  ...
  return (
    ...
    (b.prototype.build = function() {
      if (!(a('#lightbox').length > 0)) {
        ...
        this.$lightbox.hide().on('click', function(c) {
          return a(c.target).attr('id') === 'lightbox' && b.end(), !1;
        }),
    ...
    (b.prototype.start = function(b) {
      ...
      let f;
      let g = 0;
      const h = b.attr('data-lightbox');
      if (h) {
        f = a(`${b.prop('tagName')}[data-lightbox="${h}"]`);
        for (let i = 0; i < f.length; i = ++i)
          c(a(f[i])), f[i] === b[0] && (g = i);
      } else if (b.attr('rel') === 'lightbox') c(b);
      else {
        f = a(`${b.prop('tagName')}[rel="${b.attr('rel')}"]`);
        for (let j = 0; j < f.length; j = ++j)
          c(a(f[j])), f[j] === b[0] && (g = j);
      }
      const k = e.scrollTop() + this.options.positionFromTop;
    ...
    (b.prototype.changeImage = function(b) {
      ...
      const d = this.$lightbox.find('.lb-image');
    ...
    (b.prototype.sizeContainer = function(a, b) {
      ...
      var d = this;
      const e = this.$outerContainer.outerWidth();
      const f = this.$outerContainer.outerHeight();
      var g =
        a +
    ...
    (b.prototype.updateDetails = function() {
      ...
      if (
        ...
        const c = this.$lightbox.find('.lb-caption');
